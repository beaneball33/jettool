...
# 輸入: query_code(會計科目代碼) query_coid  產出: fin_data
...
# 輸入: query_code(會計科目代碼) query_coid(股票代碼)  可以產出 findata_all (產出結果與do_query函式重複)
...
# 輸入 query_code(會計科目代碼) query_length(365)，可以產出: findata_all         
